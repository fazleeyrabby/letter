    ...
    <div class="navbar-custom">
        ...
        <div class="logo-box">
            <a href="{{route('home')}}" class="logo text-center">
                     ...
                     <span class="logo-lg-text-light">Money Letter</span>
                        </span>
                <span class="logo-sm">
                        <span class="logo-sm-text-dark">Money Letter</span>
    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                <?php
                    $user_plan = \App\user_plan::where('user_id',Auth::user()->id)->orderBy('id','desc')->first();
                    $carbon = \Carbon\Carbon::now('Asia/Dhaka');
                ?>
                @if($user_plan && $carbon > $user_plan->plandate)
                    <h5 class="text-danger text-center">Please Upgrade Your Account</h5>
                    @endif
                @yield('user')
